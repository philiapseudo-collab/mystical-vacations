  ...
  return (
    <footer className="bg-navy text-white mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <h3 className="text-2xl font-serif font-bold mb-4">
              <span className="text-gold">Mystical</span> Vacations
            </h3>
            <p className="text-slate-400 mb-4">
              Experience the mystical luxury of East Africa. Curated journeys through Kenya and Tanzania.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gold">Explore</h4>
            <ul className="space-y-2">
              <li>
                <Link href="/packages" className="text-slate-400 hover:text-gold transition-colors">
                  Packages
                </Link>
              </li>
              <li>
                <Link href="/accommodation" className="text-slate-400 hover:text-gold transition-colors">
                  Accommodation
                </Link>
              </li>
              <li>
                <Link href="/transport" className="text-slate-400 hover:text-gold transition-colors">
                  Transport
                </Link>
              </li>
              <li>
                <Link href="/excursions" className="text-slate-400 hover:text-gold transition-colors">
                  Excursions
                </Link>
              </li>
            </ul>
          ...
          {/* Information */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gold">Information</h4>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-navy-light mt-8 pt-8 text-center text-slate-400">
          <p>&copy; {currentYear} Mystical Vacations. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
